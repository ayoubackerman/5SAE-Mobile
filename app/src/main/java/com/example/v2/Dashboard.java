...
public class Dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorList.add(new Doctor("Dr. Smith", "Cardiologist", R.drawable.pp)); // Replace with your images
        doctorList.add(new Doctor("Dr. Johnson", "Dermatologist", R.drawable.pp));
        doctorList.add(new Doctor("Dr. Lee", "Pediatrician", R.drawable.pp));
        doctorList.add(new Doctor("Dr. Smith", "Cardiologist", R.drawable.pp)); // Replace with your images
        doctorList.add(new Doctor("Dr. Johnson", "Dermatologist", R.drawable.pp));
        doctorList.add(new Doctor("Dr. Lee", "Pediatrician", R.drawable.pp));
